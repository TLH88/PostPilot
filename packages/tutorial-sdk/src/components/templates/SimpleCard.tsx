...
/**
 * Simple card template — minimal design with title, description, and navigation.
 * No media slot. Used as the default template.
 */
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          <span
            style={{
              ...
              background:
                "color-mix(in srgb, var(--tutorial-primary, #3b82f6) 10%, transparent)",
              padding: "3px 10px",
              borderRadius: "999px",
            }}
          >
