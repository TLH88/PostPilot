...
| UF-006 | 2026-04-26 | Test user (cycle 1) | Wants AI-generated images that "look like them" — request for reference-photo upload feeding into image prompts | [BP-140](BACKLOG.md) | **Deferred (post-GTM) 2026-05-04** — out of GTM critical path. Design preserved at [docs/plans/POST-GTM-FUTURE-FEATURES.md](plans/POST-GTM-FUTURE-FEATURES.md) |
| UF-007 | 2026-05-04 | QA agent (live walkthrough) | Onboarding wizard architectural defects: no profile-row at signup, wizard bypasses API routes, refresh restarts at step 0, skip-everything completes with empty profile, deep-link `?step=N` shows fake checkmarks | [BP-142](BACKLOG.md) | **Verified (QA, dev preview) 2026-05-04** — all 5 sub-items PASS |
| UF-008 | 2026-05-04 | QA agent (live walkthrough) | Tutorial completion never persists — `tutorial_progress.completed` stays `false` after Finish (upsert `onConflict` mismatch silently fails) | [BP-149](BACKLOG.md) | **Verified (QA, dev preview) 2026-05-04** |
| UF-009 | 2026-05-04 | QA agent (live walkthrough) | Cross-route restart from Help auto-closes tutorial within 600ms (most of the registry is unrestartable from Help) | [BP-149](BACKLOG.md) | **Verified (QA, dev preview) 2026-05-04** |
| UF-010 | 2026-05-04 | QA agent (live walkthrough) | Tutorial gate background renders translucent in dark mode, visually entangled with What's New modal | [BP-149](BACKLOG.md) | **Verified (QA, dev preview) 2026-05-04** |
| UF-011 | 2026-05-04 | QA agent (live walkthrough) | `howto-idea-generation` step 3 click on Generate doesn't advance tutorial; `overview-app` step 1 anchors to mobile-hidden sidebar | [BP-149](BACKLOG.md) | **Verified (QA, dev preview) 2026-05-04** |
| UF-012 | 2026-05-04 | QA agent (live walkthrough) | Two stacked modals (What's New + tutorial gate) over the wizard on first onboarding visit; "Got it!" sometimes needs two clicks | [BP-150](BACKLOG.md) | **Verified (QA, dev preview) 2026-05-04** |
| UF-013 | 2026-05-04 | QA agent (live walkthrough) | `/onboarding/type` is a 1-2s blank flash before redirect | [BP-150](BACKLOG.md) | **Verified (QA, dev preview) 2026-05-04** |
| UF-014 | 2026-05-04 | QA agent (live walkthrough) | Dashboard greeting first-name extraction is naive ("Back Test User" → "Welcome back, Back!"); empty-profile fallback "Welcome back, there!" looks broken | [BP-150](BACKLOG.md) | **Verified (QA, dev preview) 2026-05-04** |
| UF-015 | 2026-05-04 | QA agent (live walkthrough) | "Powered by Claude" badge claims system AI access while DB has `managed_ai_access=false` for new free users | [BP-151](BACKLOG.md) | **Verified (QA, dev preview) 2026-05-04** |
