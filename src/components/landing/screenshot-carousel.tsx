  ...
  return (
    ...
    >
      ...
      <div className="relative -mt-12 flex justify-center px-6 sm:-mt-16">
        <div
          key={`card-${active}`}
          className="relative w-full max-w-[50rem] rounded-2xl border border-foreground/10 bg-card px-6 py-5 shadow-2xl ring-1 ring-foreground/5 motion-safe:animate-in motion-safe:fade-in motion-safe:slide-in-from-bottom-2 motion-safe:duration-500 sm:px-8 sm:py-6"
        >
