  ...
  return (
    <section className="py-10 dark:bg-gray-100">
      <div className="mx-auto max-w-6xl px-6">
        <p className="mb-6 text-center text-sm font-medium tracking-wide text-muted-foreground dark:text-gray-500 uppercase">
      ...
      <div className="group relative overflow-hidden">
        {/* Gradient fade edges */}
        <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-16 sm:w-24 bg-gradient-to-r from-background dark:from-gray-100 to-transparent" />
        <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-16 sm:w-24 bg-gradient-to-l from-background dark:from-gray-100 to-transparent" />
