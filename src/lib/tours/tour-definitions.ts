    ...
    steps: [
      {
        ...
        content: "This is your home base. These cards show your content at a glance: how many ideas, drafts, scheduled posts, and published content you have.",
      ...
      },
      {
        ...
        content: "Use the sidebar to move between pages. Ideas, Posts, Library, Calendar, and more are all one click away. Each page has tooltips to help you along.",
      ...
      },
      {
        ...
        content: "Explore at your own pace. Help is always available: hover any button for a tooltip, or click the help icon to open detailed guides. Happy posting!",
        selector: "#tour-dashboard-metrics",
        side: "bottom",
        showControls: true,
        pointerPadding: 12,
